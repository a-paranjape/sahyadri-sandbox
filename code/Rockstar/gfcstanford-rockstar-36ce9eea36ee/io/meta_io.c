...
#ifdef HAVE_TIRPC
#include "io_tipsy.h"  // wrapped by Aseem 03 Nov 2023
#endif
...
#else
    fprintf(stderr, "[Error] TIPSY needs RPC/XDR support.  Recompile Rockstar uncommenting HAVE_TIRPC in Makefile.\n");
    exit(1);
#endif
  }
